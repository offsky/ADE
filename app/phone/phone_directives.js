            ...
            element.bind('click', function(e) {
                ...
                if (value !== "" && $filter('phone')(value).match('tel')) {
                    if (!$linkPopup.length) {
                        ...
                        $compile('<div class="'+ $scope.linkPopupClass +' dropdown-menu open" style="left:'+posLeft+'px;top:'+posTop+'px"><a class="'+$scope.miniBtnClasses+'" href="'+linkString+'">Call</a> or <a class="'+$scope.miniBtnClasses+'" ng-click="editLink()">Edit Link</a></div>')($scope).appendTo('body');
                    }
                } else {
                    $scope.editLink();
                }
