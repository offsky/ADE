...
adeModule.directive('adeInteger', ['$compile','$rootScope', '$filter', function($compile,$rootScope,$filter) {
	return {
		require: '?ngModel', //optional dependency for ngModel
		restrict: 'A', //Attribute declaration eg: <div ade-integer=""></div>
		...
		link: function($scope, element, attrs, controller) {
			...
			return attrs.$observe('adeInteger', function(settings) { //settings is the contents of the ade-integer="" string
				var options = {};
