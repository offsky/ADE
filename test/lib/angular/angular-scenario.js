...
angular.scenario.dsl('input', function() {
  ...
  // AM:
  chain.blur = function(value, event) {
    return this.addFutureAction("input '" + this.name + "' blurs", function($window, $document, done) {
      var input = $document.elements('[ng\\:model="$1"]', this.name).filter(':input');
      input.trigger('blur');
      done();
    });
  ...
  // AM:
  // "return" is reserved word in ie8
  chain.enterReturn = function(value, event) {
    return this.addFutureAction("input '" + this.name + "' returns", function($window, $document, done) {
      var input = $document.elements('[ng\\:model="$1"]', this.name).filter(':input');
      var e = $window.jQuery.Event("keyup");
      e.keyCode = 13;
      $window.jQuery(input).trigger(e);
      done();
    });
  };

  // AM:
  chain.escape = function(value, event) {
    return this.addFutureAction("input '" + this.label + "' escapes", function($window, $document, done) {
...
angular.scenario.dsl('element', function() {
  ...
  // AM:
  chain.clickByPosition = function(index) {
    return this.addFutureAction("element '" + this.label + "' click by position", function($window, $document, done) {
      var elements = $document.elements();
      var href = elements.attr('href');
      var eventProcessDefault = $window.jQuery(elements[index-1]).trigger('click')[0];
   ...
   // AM:
  chain.doubleClickByPosition = function(index) {
    return this.addFutureAction("element '" + this.label + "' click by position", function($window, $document, done) {
      var elements = $document.elements();
      var href = elements.attr('href');
      var eventProcessDefault = $window.jQuery(elements[index-1]).trigger('dblclick')[0];
  ...
  // AM:
  chain.dragByPosition = function(index, positions) {
    return this.addFutureAction("element '" + this.label + "' drag by position", function($window, $document, done) {
      var elements = $document.elements();
      var href = elements.attr('href');
      $window.jQuery(elements[index-1]).simulateDragSortable({move: positions, handle:".handle", tolerance: 5});
  ...
  // AM:
  // chain.dragDrop = function(indexFrom, indexTo) {
  //   return this.addFutureAction("element '" + this.label + "' drag and drop", function($window, $document, done) {
  //     var elements = $document.elements();
  //     var href = elements.attr('href');
  //     var dropOn = $window.jQuery("#root ul")[indexTo-1];
  //     $window.jQuery(elements[indexFrom-1]).simulateDragSortable({move: 0, handle: ".handle", dropOn: "#" + dropOn.id});
  ...
  // AM:
  // chain.isVisible = function(index) {
  //   return this.addFutureAction("element '" + this.label + "' is visible", function($window, $document, done) {
  //     var elements = $document.elements();
  //     var href = elements.attr('href');
  //     return done($window.jQuery(elements[index-1]).is(":visible"));
  //     // done();
  //   });
  // };
  ...
  // AM:
  chain.blur = function() {
    return this.addFutureAction("element '" + this.label + "' blurs", function($window, $document, done) {
      var input = $document.elements();
      input.trigger('blur');
      done();
    });
  ...
  // AM:
  // "return" is a reserved word in ie8
  chain.enterReturn = function() {
    return this.addFutureAction("element '" + this.label + "' returns", function($window, $document, done) {
      var input = $document.elements();
      var e = $window.jQuery.Event("keyup");
      e.keyCode = 13;
      $window.jQuery(input).trigger(e);
  ...
  // AM:
  chain.tab = function() {
    return this.addFutureAction("element '" + this.label + "' tabs", function($window, $document, done) {
      var input = $document.elements();
      var e = $window.jQuery.Event("keydown");
      e.keyCode = 9;
      $window.jQuery(input).trigger(e);
      done();
    });
  ...
  // AM:
  chain.shiftTab = function() {
    return this.addFutureAction("element '" + this.label + "' shift tabs", function($window, $document, done) {
      var input = $document.elements();
      var e = $window.jQuery.Event("keydown");
      e.keyCode = 9;
      e.shiftKey = true;
  ...
  chain.escape = function() {
    return this.addFutureAction("element '" + this.label + "' escapes", function($window, $document, done) {
      var input = $document.elements();
      var e = $window.jQuery.Event("keyup");
      e.keyCode = 27;
      $window.jQuery(input).trigger(e);
  ...
  // AM:
  chain.down = function() {
    return this.addFutureAction("element '" + this.label + "' keys down", function($window, $document, done) {
      var input = $document.elements();
      var e = $window.jQuery.Event("keydown");
      e.keyCode = 40;
      $window.jQuery(input).trigger(e);
  ...
  // AM:
  chain.up = function() {
    return this.addFutureAction("element '" + this.label + "' keys up", function($window, $document, done) {
      var input = $document.elements();
      var e = $window.jQuery.Event("keydown");
      e.keyCode = 38;
      $window.jQuery(input).trigger(e);
  ...
  // AM:
  chain.space = function(value, event) {
    return this.addFutureAction("element '" + this.label + "' space", function($window, $document, done) {
      var input = $document.elements();
      var e = $window.jQuery.Event("keydown");
      e.keyCode = 32;
      $window.jQuery(input).trigger(e);
  ...
  // AM:
  chain.isHighlighted = function() {
    return this.addFutureAction("element '" + this.label + "' is highlighted", function($window, $document, done) {
    	var isHighlighted = $document.elements().hasClass('highlight');
    	done(null, isHighlighted);
    });
  };

  // AM:
  chain.isDisplayed = function() {
    return this.addFutureAction("element '" + this.label + "' is displayed", function($window, $document, done) {
    	var isDisplayed = $document.elements()[0].style['cssText'] === '';
    	done(null, isDisplayed);
    });
  };
