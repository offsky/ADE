...
describe('icon', function() {
    ...
    it('should return a clear (square with grey background) icon', function() {
        expect(iconFilter('ban-circle')).toEqual('<span class="ade-icon icon-ban-circle">');
    });

    it('should return a clear icon because we gave it a bad icon', function() {
        expect(iconFilter('doesntexist')).toEqual('<span class="ade-icon icon-ban-circle">');
        expect(iconFilter(123)).toEqual('<span class="ade-icon icon-ban-circle">');
    });
});
