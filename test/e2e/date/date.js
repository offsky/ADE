...
describe('date', function() {
	...
	it('should go into edit mode', function() {
		...
		expect(element('.ade-editme:eq(0) + input').count()).toEqual(1);
	});
	...
	it('should dismiss a popup on ENTER', function() {
		...
		expect(element('.ade-editme:eq(0)').text()).toBe('2013');
	...
	it('should allow entering value into input', function() {
		...
		expect(element('.ade-editme:eq(0)').text()).toBe('2009');
		expect(element('.ade-editme + input').count()).toEqual(0);
	});
	...
	it('should edit/save entry with ENTER', function() {
		...
		expect(element('.ade-editme:eq(0)').text()).toBe('2019');
		expect(element('.ade-editme + input').count()).toEqual(0);
	});
	...
	it('should accept clicks on the calendar', function() {
		element('.ade-editme:eq(2)').click();
		expect(element('.ade-editme:eq(2)').text()).toBe('Jan 1, 2013 12:00:00 AM');
